...
func (in *DeleteRules) DeepCopyInto(out *DeleteRules) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeleteRules.
func (in *DeleteRules) DeepCopy() *DeleteRules {
	if in == nil {
		return nil
	}
	out := new(DeleteRules)
...
func (in *SidecarSpec) DeepCopyInto(out *SidecarSpec) {
	*out = *in
	if in.DeleteRules != nil {
		in, out := &in.DeleteRules, &out.DeleteRules
		*out = make([]DeleteRules, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
